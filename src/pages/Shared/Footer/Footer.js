        ...
        <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    <img className='w-10 h-10' src={photo} alt="" />
                    <div>
                        <p><span className='text-2xl font-semibold'>Picturesque Ltd.</span> <br />Providing reliable photo since 1999</p>
                        <small>Copyright © 2022 - All right reserved by Picturesque Ltd</small>
                    </div>
                </div>
